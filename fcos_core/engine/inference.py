        ...
        with torch.no_grad():
            ...
            if cfg.TEST.BBOX_AUG.ENABLED:
                if cfg.TEST.BBOX_AUG.VOTE:
                    output = im_detect_bbox_aug_vote(arguements, model, images, device)
                else:
                    output = im_detect_bbox_aug(arguements, model, images, device)
            else:
                print('Starting Training')
                output = model(arguements, images.to(device))
            if timer:
