...
_C.MODEL.WEIGHT = ""
#_C.MODEL.CLS_WEIGHT = ""
_C.MODEL.CLS_WEIGHT = "/media/ubuntu/D/wh/CVPR2021/models/R-34.pth"
_C.MODEL.REG_WEIGHT = "/media/ubuntu/D/wh/CVPR2021/models/R-101.pkl"
_C.MODEL.WEIGHT = "/media/ubuntu/D/wh/CVPR2021/models/R-101.pkl"
...
_C.MODEL.BACKBONE.CLS_CONV_BODY = "R-50-C4"
_C.MODEL.BACKBONE.REG_CONV_BODY = "R-50-C4"
...
_C.MODEL.RESNETS.CLS_NUM_GROUPS = 1
_C.MODEL.RESNETS.REG_NUM_GROUPS = 1

# Baseline width of each group
_C.MODEL.RESNETS.WIDTH_PER_GROUP = 64
_C.MODEL.RESNETS.CLS_WIDTH_PER_GROUP = 64
_C.MODEL.RESNETS.REG_WIDTH_PER_GROUP = 64

# Place the stride 2 conv on the 1x1 filter
# Use True only for the original MSRA ResNet; use False for C2 and Torch models
_C.MODEL.RESNETS.STRIDE_IN_1X1 = True
_C.MODEL.RESNETS.CLS_STRIDE_IN_1X1 = True
_C.MODEL.RESNETS.REG_STRIDE_IN_1X1 = True
# Residual transformation function
_C.MODEL.RESNETS.TRANS_FUNC = "BottleneckWithFixedBatchNorm"
_C.MODEL.RESNETS.CLS_TRANS_FUNC = "BasicWithFixedBatchNorm"
_C.MODEL.RESNETS.CLS_LIGHT_WEIGHT = False
...
_C.MODEL.RESNETS.CLS_RES2_OUT_CHANNELS = 256
...
_C.MODEL.RESNETS.CLS_STAGE_WITH_DCN = (False, False, False, False)
_C.MODEL.RESNETS.CLS_WITH_MODULATED_DCN = False
_C.MODEL.RESNETS.CLS_DEFORMABLE_GROUPS = 1

_C.MODEL.RESNETS.REG_STAGE_WITH_DCN = (False, False, False, False)
_C.MODEL.RESNETS.REG_WITH_MODULATED_DCN = False
_C.MODEL.RESNETS.REG_DEFORMABLE_GROUPS = 1
